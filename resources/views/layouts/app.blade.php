...
<head>
    ...
    <script src="https://use.fontawesome.com/7729955f9f.js"></script>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @if(Auth::user()->role_id == 1)
                            <li class="dropdown">
                                ...
                                <i class="fa fa-lock" aria-hidden="true"></i> Admin<span class="caret"></span>
                                </a>
                                ...
                                <ul class="dropdown-menu" role="menu">
                                 ...
                                 <li><a href="{{ route('roles.index') }}"><i class="fa fa-user-circle" aria-hidden="true"></i> All Roles</a></li>
                                </ul>
                            </li>
                        @endif
